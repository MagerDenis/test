...
public class create_paid_user_GBR_FF extends SeleneseTestCase {
	...
	@Test
	public void testCreate_paid_user_GBR1() throws Exception {
		try
		{
		...
		utils.CheckText("$25", "//div[6]/div[2]/div/em", "Create_paid_account_gbr_FF Fail");
		selenium.click("//div[@id='signup-currency']/tt");
		selenium.click("//div[@id='signup-currency']/div/a[2]/tt");
		selenium.waitForPageToLoad("30000");
		...
		utils.CheckText(s, "//div[7]/div[2]/div/em", "Create_paid_account_gbr_FF Fail");
		...
		selenium.waitForPageToLoad("30000");
		utils.CheckText("£" + i +"/yr", "//div[4]/span", "Create_paid_account_gbr_FF Fail");
		selenium.clickAt("//tt", "");
		...
		//verifyTrue(selenium.isTextPresent("£40/yr"));
		
		Thread.sleep(2000);		
		utils.CheckText("£" + (i+40) + "/yr", "//div[6]/span", "Create_paid_account_gbr_FF Fail");
		...
		//utils.CheckText("£" + i + ".00", "//div[7]/span", "Create_paid_account_gbr_FF Fail");
		...
		selenium.type("//input[contains(@id, '_PaymentForm-cardCvv')]", "123");
		...
		Thread.sleep(1000);
		utils.CheckValue("XXXX XXXX XXXX 1111", "document.forms[2].elements[6]", "Create_paid_account_gbr_FF Fail");
		...
		Thread.sleep(1000);
		utils.CheckText("£" + (i+40) + ".00", "//div[7]/span", "Create_paid_account_gbr_FF Fail");
	...
	/*	for (int second = 0;; second++) {
		...
		*/
		Log.print("FF GBR email: AutomationTest"+random+"@zenfolio.com");
		...
		utils.CheckText("All Photographs", "//div[4]/span", "Create_paid_account_gbr_FF Fail");
		//verifyTrue(selenium.isTextPresent("All Photographs"));
		selenium.click("//div[@id='zenbar']/div/a[2]/span");
		selenium.waitForPageToLoad("30000");
		utils.CheckElement("//div[@id='GettingStarted_Dialog__body']/div[2]/div[2]/div[1]/p[2]", "Create_paid_account_gbr_FF Fail");
		...
		utils.CheckText("Organizer", "//div[@id='ctl01-left']/h2", "Create_paid_account_gbr_FF Fail");
		...
		selenium.waitForPageToLoad("30000");
		utils.CheckText("All Photographs", "//div[4]/span", "Create_paid_account_gbr_FF Fail");
		utils.CheckElement("link=Logout", "Create_paid_account_gbr_FF Fail");
		//verifyTrue(selenium.isTextPresent("All Photographs"));
		...
		selenium.waitForPageToLoad("30000");
		Thread.sleep(5000);
		utils.CheckNotElement("//div[contains(@id, 'zenbar')]//a[contains(text(),'Logout')]", "Create_paid_account_gbr_FF Fail");
		...
		{
			selenium.captureEntirePageScreenshot("c:\\temp\\AccountGbrFF.jpg", "");
			throw ex;
		}
		}
